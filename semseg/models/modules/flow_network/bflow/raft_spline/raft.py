...
from ..raft_utils.corr import CorrComputation, CorrBlockParallelMultiTarget
from ..raft_utils.utils import coords_grid
from ..raft_utils.timers import CudaTimerDummy as CudaTimer
...
class RAFTSpline(nn.Module):
    ...
    # def __init__(self, model_params: Dict[str, Any]):
        ...
        self.bezier_degree = 2
        self.detach_bezier = False
